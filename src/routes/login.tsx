...
function LoginPage() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden noise grid grid-cols-1 lg:grid-cols-[1.05fr_1fr]">
      ...
      {/* right: form */}
      <main className="relative flex items-center justify-center px-5 py-10 sm:px-10 sm:py-14 lg:py-12">
        <motion.div
        ...
        >
          ...
          <Link
            to="/"
            className="lg:hidden inline-flex items-center gap-2 text-[13px] text-muted-foreground mb-8 sm:mb-10"
          >
            <span className="h-1.5 w-1.5 rounded-full bg-accent" />
          ...
          {/* heading */}
          <h2 className="font-display text-[1.75rem] sm:text-[2.25rem] leading-[1.1] sm:leading-[1.05] tracking-[-0.03em] font-medium">
            {isSignup ? (
          ...
          <button
            onClick={google}
            type="button"
            className="mt-8 sm:mt-10 w-full group flex items-center justify-center gap-3 px-5 h-11 sm:h-12 rounded-md border border-white/10 bg-white/[0.02] hover:bg-white/[0.05] hover:border-white/20 transition-colors"
          >
          ...
          <div className="my-6 sm:my-7 flex items-center gap-4 text-xs text-muted-foreground/50">
          ...
          <form onSubmit={submit} className="space-y-4 sm:space-y-5">
            <div>
              ...
              <input
                ...
                spellCheck={false}
                className="w-full h-11 sm:h-12 rounded-md border border-white/10 bg-white/[0.02] px-4 text-[16px] sm:text-[15px] outline-none placeholder:text-muted-foreground/40 focus:border-accent/60 focus:bg-white/[0.04] transition-colors"
              />
            </div>
            <div>
              ...
              <input
                ...
                placeholder="••••••••••"
                className="w-full h-11 sm:h-12 rounded-md border border-white/10 bg-white/[0.02] px-4 text-[16px] sm:text-[15px] outline-none placeholder:text-muted-foreground/40 focus:border-accent/60 focus:bg-white/[0.04] transition-colors tracking-widest"
              />
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="mt-1 w-full h-11 sm:h-12 bg-foreground text-background text-sm font-medium px-6 rounded-md hover:bg-accent hover:text-accent-foreground transition-colors disabled:opacity-60 flex items-center justify-center gap-2"
            >
              {loading ? (
                <>
          ...
          <div className="mt-7 sm:mt-8 text-[13.5px] sm:text-sm text-muted-foreground">
